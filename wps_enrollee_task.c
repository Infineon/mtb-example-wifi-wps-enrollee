...
#ifdef WPS_AP_PIN
            /* Here, the WPS PIN is specified by the AP.*/
            wps_config.password = WPS_AP_PIN;
            APP_INFO(("AP PIN: \'%s\' is used.\n", WPS_AP_PIN));
#else
 ...
 *
 ******************************************************************************/
cy_rslt_t wifi_connect(cy_wcm_connect_params_t *connect_param, cy_wcm_ip_address_t *ip_address )
{
